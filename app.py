...
class ChatApplication:
    ...
    def _setup_main_window(self):
        ...
        self.text_widget=Text(self.window,width=450,bg=BG_COLOR,fg=TEXT_COLOR,
                              font=FONT,padx=5,pady=5)
        ...
        self.msg_entry.place(relwidth=0.74,relheight=0.06,relx=0.011,rely=0.011)
